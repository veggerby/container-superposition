...
describe('Overlay Loader', () => {
  ...
  describe('loadOverlaysConfig', () => {
    ...
    it('should correctly categorize overlays', () => {
      ...
      // Language overlays
      expect(config.overlays.some(o => o.id === 'nodejs' && o.category === 'language')).toBe(true);
      expect(config.overlays.some(o => o.id === 'python' && o.category === 'language')).toBe(true);

      // Database overlays
      expect(config.overlays.some(o => o.id === 'postgres' && o.category === 'database')).toBe(true);
      expect(config.overlays.some(o => o.id === 'redis' && o.category === 'database')).toBe(true);

      // Observability overlays
      expect(config.overlays.some(o => o.id === 'prometheus' && o.category === 'observability')).toBe(true);
      expect(config.overlays.some(o => o.id === 'grafana' && o.category === 'observability')).toBe(true);

      // Cloud tools
      expect(config.overlays.some(o => o.id === 'aws-cli' && o.category === 'cloud')).toBe(true);
      expect(config.overlays.some(o => o.id === 'kubectl-helm' && o.category === 'cloud')).toBe(true);

      // Dev tools
      expect(config.overlays.some(o => o.id === 'docker-sock' && o.category === 'dev')).toBe(true);
      expect(config.overlays.some(o => o.id === 'playwright' && o.category === 'dev')).toBe(true);
    });
