...
- **Schema required**: run `npm run schema:generate` after adding/changing overlays or `ProjectConfigSelection` types, then commit the updated `tool/schema/superposition.schema.json`
