...
constitution. If implementation changes behavior, add automated tests or record
why automation is not practical plus the manual validation steps.
...
- [ ] T001 Confirm spec is committed at `docs/specs/[###-feature-name]/spec.md`
- [ ] T002 Confirm spec review/approval is recorded before implementation starts
- [ ] T003 Create project structure per implementation plan
- [ ] T004 [P] Configure tooling required for implementation and verification
...
- [ ] TXXX Update `CHANGELOG.md` for user-visible behavior changes
...
- Required verification tasks MUST be written and fail before implementation when
...
- Verify required validation fails before implementing, or document why that is
  not practical
